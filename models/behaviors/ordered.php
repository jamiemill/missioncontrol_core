 ...
 * $this->CorePage->deleteAll(array('user_id'=>22),true,array('beforeDelete','afterDelete'));
 * 
 ...
 * 
 * //in controller action :
 * $this->CorePage->sortby('content DESC', $book_id);
